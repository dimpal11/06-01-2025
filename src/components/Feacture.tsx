...
export default function Feacture() {
  ...
  const VideoModal = () => {
    return (
      <div className="relative top-[-230px] left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
...
<div className="h-[300px] w-full md:h-[560px] xl:h-[660px] lg:w-[90%] lg:h-[660px] xl:w-[75%] bg-gradient-to-r from-[#F0DB92]  to-[#BF9033] flex justify-center items-center bg-abc">
...
<div className='absolute top-[108px] md:top-[238px] lg:top-[300px] xl:[300px]'>
  ...
  <button className='flex justify-center mx-auto' onClick={() => setShowModal(true)}>  <Image src={playbutton}  alt='logo' ></Image>
        </button>
